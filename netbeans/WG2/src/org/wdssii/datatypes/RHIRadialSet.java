 ...
 */
public class RHIRadialSet extends DataType implements Table2DView {

	private static Logger log = LoggerFactory.getLogger(RHIRadialSet.class);
	 ...
	 */
	public static class RHIRadialSetMemento extends DataType.DataTypeMemento {
	...
	public void queryData(PPIRadialSet.PPIRadialSetQuery q) {
		...
		PPIRadialSet.SphericalLocation a = null;
		if (q.inSphere != null) {
			a = q.inSphere;
			haveLocation = true;
		} else {
			if (q.inLocation != null) {
				a = new PPIRadialSet.SphericalLocation();
