...
public class RadialSet extends DataType {
	...
	/**
	 * Fixed angle in degrees of this radial set. This is the unchanging
	 * angle of the RadialSet, it will be elevation for PPI and azimuth for
	 * RHI
	 */
	...
	/**
	 * The array of Radial that we hold. These are in load order, not sorted
	 * in any way.
	 */
	...
	public static class RadialSetMemento extends DataTypeMemento {
		...
		/**
		 * The fixed angle in degrees of this radial set, for PPI this
		 * is the elevation of the RadialSet
		 */
	...
	/**
	 * Get the range to the beginning of the first gate in Kms for all
	 * Radial
	 */
	 ...
	 * for RadialSets this would normally be fixed angle of the RadialSet.
	 * For example, PPIRadialSets will sort by elevation. For example,
	 * RHIRadialSets will sort by azimuth.
	 *
	...
	*/
	...
	/** Given speed in meters per second, a direction in degrees (for the SRM vector),
	 * and an azimuth, generates the SRM value
	 * 
