 ...
 *
 * The GUI that will use our own swing view for displaying running jobs. We'll
 * use an executor to handle running jobs
 *
 * We'll link to a JobsView... FIXME: make all the job stuff part of
 * org.wdssii.jobs The 'swing' stuff, etc... all here for now as I crank out the
 * code will organize it later
 *
 */
public class JobManager {
	...
	public static class JobSwingRunner implements WdssiiJobRunner {
		...
		/**
		 * Currently we have one JobsView window..this is set to
		 * non-null once it's made...bleh..might try to use before it's
		 * ready...
		 *
		 */
