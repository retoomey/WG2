...
// are a billion methods, lol...
	...
	private boolean myEarthBallMade = false;

	private double myXScale;

	private double myYScale;

	private GLUquadric myEarthQuadric;

	private int myDensity = 500;

	private boolean myFirstTime = true;

	//private Texture myTexture;

	private GLTexture myGLTexture;

	private int myTextureID;

	private GLContext myGLContext;
