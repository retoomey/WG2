 ...
 *
 * Create a worldwind earth view in a 'chart'
 *
 * @author Robert Toomey
 */
public class WorldWindChart extends ChartViewChart {

    private final static Logger LOG = LoggerFactory.getLogger(WorldWindChart.class);
     ...
     */
    public static WorldWindChart createWorldWindChart() {

        return new WorldWindChart();
