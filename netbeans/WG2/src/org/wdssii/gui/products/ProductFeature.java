...
public class ProductFeature extends Feature {
     ...
     */
    private DataType myLoadedDatatype = null;
...
*/
    ...
    /**
     * Called by multiple table views to display a table for this ProductFeature
     *
     * @return
     */
    ...
    /**
     * Get the loaded datatype. Since datatype can lazy load, this could return
     * null for a while...
     *
     * @return the loaded datatype
     */
    public DataType getLoadedDatatype() {
        Product p = getProduct();
        // Try to update current product datatype (lazy load)
        if ((p != null) && p.updateDataTypeIfLoaded()) {
            myLoadedDatatype = p.getRawDataType();
        } else {
            myLoadedDatatype = null;
        }

        return myLoadedDatatype;
    }
