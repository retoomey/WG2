...
/**
 * A Product volume that uses individual records for 'up' and 'down'.
 * RadialSets are an example of this type of volume
 * LatLonGrids are an example of this type of volume
 * 
...
public class IndexRecordVolume extends ProductVolume {
    ...
    /** What's funny is that the standard up doesn't require any volume
     * data..
     * @return 
     */
    @Override
