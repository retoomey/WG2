...
public class IndexView extends JThreadPanel implements CommandListener, CONUSJPanelListener {
    ...
    private static Logger log = LoggerFactory.getLogger(IndexView.class);
    ...
    private JPanel createIndexLoadPanel() {
        ...
        JPanel p = new JPanel();
        p.setLayout(new MigLayout("wrap 3", "[pref!][grow][align right]",
                "[pref!|pref!|pref!|pref!|pref!|pref!|grow]"));
        // Catalog section
        p.add(new JLabel("Catalog:"));
        jBookmarkComboBox = new javax.swing.JComboBox();
        p.add(jBookmarkComboBox, new CC().growX().spanX(2).wrap());
        p.add(new JLabel("Group:"));
        jGroupComboBox = new javax.swing.JComboBox();
        p.add(jGroupComboBox, new CC().growX().spanX(1));
        JButton refresh = new JButton("Refresh");
        p.add(refresh, new CC().wrap());

        p.add(new JSeparator(), new CC().growX().spanX(3).wrap());

        // Index information section
        p.add(new JLabel("Index URL:"));
        jURLTextField = new javax.swing.JTextField();
        p.add(jURLTextField, new CC().growX().spanX(2).wrap());
        p.add(new JLabel("Source Name:"));
        jNameTextField = new javax.swing.JTextField();
        p.add(jNameTextField, new CC().growX().spanX(2).wrap());
        ...
        p.add(jComboBox2, new CC().growX());
        JButton add = new JButton("Add this index");
        p.add(add, new CC().wrap());

        jBookTabPane = new javax.swing.JTabbedPane();
        p.add(jBookTabPane, new CC().spanX(3).growX().growY());
    ...
    public void addNewSourceFromFields(boolean confirm, boolean report) {
        ...
        if (name.isEmpty()) {
            ...
            SourceAddCommand c = new SourceAddCommand(name, path, realtime, connect, historyValue);
