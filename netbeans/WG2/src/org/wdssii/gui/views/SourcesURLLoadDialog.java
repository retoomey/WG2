...
public class SourcesURLLoadDialog extends JDialog implements ActionListener {
    ...
    public SourcesURLLoadDialog(JFrame owner, JComponent location, boolean modal, String myMessage) {

        super(owner, modal);
        init(location, myMessage);
    }

    public SourcesURLLoadDialog(JDialog owner, JComponent location, boolean modal, String myMessage) {
...
//							|| t.endsWith(".xml") || t.endsWith(".xml.gz"));
    ...
    /**
     * Sent by GUIPlugInPanel when it's handled the user clicking OK, usually by
     * creating/loading the source
     */
