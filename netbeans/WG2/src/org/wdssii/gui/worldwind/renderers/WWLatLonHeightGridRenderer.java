...
// FIXME: Remove these dependencies to make this class render inside of 
// a GLWorld object instead of worldwind
 ...
 *  FIXME: Currently requires world wind to draw..
 * 
 * @author Robert Toomey
 */
public class WWLatLonHeightGridRenderer extends ProductRenderer {

    private final static Logger LOG = LoggerFactory.getLogger(WWLatLonHeightGridRenderer.class);
    protected int updateCounter = 0;
    
    protected QuadStripRenderer myQuadRenderer = new QuadStripRenderer();
    
    public WWLatLonHeightGridRenderer() {
        super(true);
    }
    
    public WWLatLonHeightGridRenderer(boolean asBackgroundJob) {
