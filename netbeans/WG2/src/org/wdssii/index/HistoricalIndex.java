...
public class HistoricalIndex implements IndexRecordListener {
    ...
    /**
     * Max records to linearly search back for the 'base'. More than this many
     * subtypes will cause base to be null.
     */
    public final static int MAX_BASE_SEARCH = 100;
    /**
    ...
    public IndexRecord getPreviousLowestRecord(
        ...
        // FIXME: Grabbed this code from VolumeRecord.getVolumeRecord
        // There are two different code sections for getting the records, 
        // we need to revisit this.  It's because the display works with 'volumes'
        // while product navigation goes directly to records...
        ...
        while (keepGoing) {
            ...
            IndexRecord previous = getRecord(current, Direction.PreviousSubType);
            if ((previous != null)
