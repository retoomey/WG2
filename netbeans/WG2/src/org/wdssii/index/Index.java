...
public abstract class Index {
	...
	/**
	 * The update() method will be called periodically. The implementation
	 * is allowed to ignore update() calls that happen at inconvenient
	 * times.
	 */
	...
	/**
	 * @return true if the last update or load of data was successful The
	 * GUI uses this to mark an index as having a problem or not
	 */
	 ...
	 * 'base' could be something like http://www.myserver.com/ktlx where
	 * files are http://www.myserver.com/ktlx/reflectivity/file1.tar.gz
	 *
	 * @return
	 */
	...
	/**
	 * Create a new URL by taking a base and adding extra stuff to the end
	 * of it. The query is kept in place. This method will take a URL like:
	 * http://tensor.protect.nssl:8080/?test=test and a string like
	 * "webindex" and create a URL:
