...
/**
 * Taken from sun internal classes and modified for own use,
 * I need special formatting of XML output, the original sun classes
 * are internal so this is a copy for safety.
 * 
 ...
 */
public class mIndentingXMLStreamWriter extends mDelegatingXMLStreamWriter {
    ...
    public mIndentingXMLStreamWriter(XMLStreamWriter writer) {
        super(writer);
    }
